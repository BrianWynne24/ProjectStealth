...
private: \
	...
	friend struct Z_Construct_UClass_AArgusCharacter_Statics; \
public: \
	DECLARE_CLASS(AArgusCharacter, AStealthCharacter, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Stealth"), NO_API) \
	DECLARE_SERIALIZER(AArgusCharacter)


#define Stealth_Source_Stealth_ArgusCharacter_h_15_INCLASS \
private: \
	static void StaticRegisterNativesAArgusCharacter(); \
	friend struct Z_Construct_UClass_AArgusCharacter_Statics; \
public: \
...
private: \
	...
	NO_API AArgusCharacter(const AArgusCharacter&); \
public:
...
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AArgusCharacter); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AArgusCharacter); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(AArgusCharacter)
...
#define Stealth_Source_Stealth_ArgusCharacter_h_15_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	Stealth_Source_Stealth_ArgusCharacter_h_15_PRIVATE_PROPERTY_OFFSET \
	Stealth_Source_Stealth_ArgusCharacter_h_15_SPARSE_DATA \
...
template<> STEALTH_API UClass* StaticClass<class AArgusCharacter>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Stealth_Source_Stealth_ArgusCharacter_h
